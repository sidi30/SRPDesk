...
export const FR = {
  ...
  integrations: {
    ...
    subtitle: 'Automatisez l\u2019upload de vos SBOM depuis vos pipelines CI/CD',
    apiKeys: 'Cl\u00e9s API',
    createKey: 'Cr\u00e9er une cl\u00e9',
    keyCreated: 'Cl\u00e9 API cr\u00e9\u00e9e avec succ\u00e8s. Copiez-la maintenant, elle ne sera plus affich\u00e9e.',
    name: 'Nom',
    prefix: 'Pr\u00e9fixe',
    status: 'Statut',
    ...
    revoke: 'R\u00e9voquer',
    never: 'Jamais',
    noKeys: 'Aucune cl\u00e9 API. Cr\u00e9ez-en une pour commencer.',
    ciConfig: 'Configuration CI/CD',
    ciHint: 'Copiez le snippet correspondant \u00e0 votre CI et ajoutez votre cl\u00e9 API en tant que secret.',
    copy: 'Copier',
    copied: 'Copi\u00e9 !',
    secretHint: 'Ajoutez la variable SRPDESK_API_KEY dans les secrets de votre projet CI/CD.',
    cancel: 'Annuler',
    confirm: 'Confirmer ?',
    creating: 'Cr\u00e9ation...',
    create: 'Cr\u00e9er',
